...
extern "C" void VQBuild(float *original_data, unsigned int original_size, int original_dim, char *prefix);
...
extern "C" void VQQuery(unsigned int *result, float *query_set, unsigned int query_size,
